...
| `costsModuleKey` | `string` | `"productCosts"` | Container key of the optional product costs module, resolved lazily. Without it every offer is skipped with `missing-break-even`. There is never a default floor. |
