...
| `costsModuleKey` | `string` | `"productCosts"` | Klucz kontenera opcjonalnego modułu kosztów, rozwiązywany leniwie. Bez niego każda oferta jest pomijana z `missing-break-even`. Nie ma domyślnego progu. |
